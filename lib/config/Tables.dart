...
final String CONTRATO =
    "CREATE TABLE IF NOT EXISTS 'contrato' ('idContrato'	INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,'contratante_idContratante'	INTEGER,'contratado_idContratado'	INTEGER,'condicoesFinanceiras_idCondicoesFinanceiras'	INTEGER,'status_idStatus'	INTEGER,'tipoContrato_idTipoContrato'	INTEGER,FOREIGN KEY('tipoContrato_idTipoContrato') REFERENCES 'tipoContrato'('idTipoContrato'),FOREIGN KEY('status_idStatus') REFERENCES 'status'('idStatus'),FOREIGN KEY('condicoesFinanceiras_idCondicoesFinanceiras') REFERENCES 'condicoesFinanceiras'('idCondicoesFinanceiras'),FOREIGN KEY('contratante_idContratante') REFERENCES 'contratante'('idContratante'),FOREIGN KEY('contratado_idContratado') REFERENCES 'contratado'('idContratado'))";
