import 'package:desafiocoimbra/DAO/CondicoesDAO.dart';
...
import 'package:desafiocoimbra/DAO/TipoContratoDAO.dart';
...
class _AddContratoState extends State<AddContrato> {
  ...
  _save() async {
    if (carencia.text.isNotEmpty &&
      ...
      print(contrato.toMap());
      //print(await condicoesDAO.insert(condicoesFinanceiras: condicoesFinanceiras));
    } else {
